export declare const CandidatoSubtipoRepo: {
    replaceSubtipos(candidatoId: number, disabilities: Array<{
        typeId: number;
        subtypeId: number;
        barriers: number[];
    }>): Promise<({
    ...
    replaceSubtiposAndAccessibilities(candidatoId: number, disabilities: Array<{
        typeId: number;
        subtypeId: number;
        barriers: number[];
...
//# sourceMappingURL=candidatoSubtipo.repo.d.ts.map