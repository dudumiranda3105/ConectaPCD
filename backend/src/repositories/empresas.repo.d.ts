export declare const EmpresasRepo: {
    ...
    findById(id: number): import("@prisma/client").Prisma.Prisma__EmpresaClient<({
        vagas: {
            id: number;
            descricao: string;
            escolaridade: string;
    ...
    findByCnpj(cnpj: string): import("@prisma/client").Prisma.Prisma__EmpresaClient<{
        id: number;
        nome: string;
        descricao: string | null;
        createdAt: Date;
    ...
    create(nome: string, cnpj?: string, email?: string): import("@prisma/client").Prisma.Prisma__EmpresaClient<{
        id: number;
        nome: string;
        descricao: string | null;
        createdAt: Date;
