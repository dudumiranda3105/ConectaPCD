export declare const upsertByUserId: (candidateId: number, profileData: any) => Promise<({
    acessibilidades: ({
        acessibilidade: {
            id: number;
            nome: string | null;
...
export declare const findByUserId: (candidateId: number) => Promise<({
    acessibilidades: ({
        acessibilidade: {
            id: number;
            nome: string | null;
...
//# sourceMappingURL=candidateProfile.repo.d.ts.map