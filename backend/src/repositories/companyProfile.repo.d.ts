export declare const upsertByUserId: (userId: number, companyData: any) => Promise<{
    id: number;
    nome: string;
...
export declare const findByUserId: (userId: number) => Promise<{
    id: number;
    nome: string;
    descricao: string | null;
    createdAt: Date;
...
//# sourceMappingURL=companyProfile.repo.d.ts.map