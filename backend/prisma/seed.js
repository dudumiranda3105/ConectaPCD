...
async function main() {
    ...
    // Barreiras
    const [escadas, degrausAltos, pisoIrregular, faltaInterprete, comunicacaoOral, faltaContraste, faltaSinalizacaoTatil] = await prisma.$transaction([
    ...
    // Acessibilidades
    const [rampa, pisoAntid, elevador, interprete, chatInterno, altoContraste, pisoGuia, rampasAcesso, sanitariosAdaptados, pisoTatil, mobiliarioAdaptado, vagasEstacionamento, portasLargas, corrimãos, iluminacaoAdequada, sinalizacaoVisual, audioDescricao, legendasVideos] = await prisma.$transaction([
